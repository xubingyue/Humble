...
public:
    ...
    CChan *regSendChan(const char *pszChanName, const char *pszTaskName, const size_t iCount);
    CChan *regRecvChan(const char *pszChanName, const char *pszTaskName, const size_t iCount);
